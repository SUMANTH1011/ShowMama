                ...
                <div className="md:max-w-96">
                   <h1 className='text-2xl font-bold cursor-pointer hover:opacity-90'>
                    ...
                    <p className="mt-6 text-sm">
                        Dive into a world of cinema with ShowMama — from blockbuster trailers to hidden gems, curated just for true movie lovers.
                    </p>
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20 md:gap-40">
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                            <p>+91 9949923451</p>
                            <p>showmama@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <p className="pt-4 text-center text-sm pb-5">
                Copyright {new Date().getFullYear()} © ShowMama.All Right Reserved.
            </p>
        </footer>
  )
}
