...
export const addShow = async (req, res) => {
  try {
    ...
    res.json({ success: true, message: "New show(s) added successfully" });
...
export const getShow=async(req,res)=>{
  try{
    ...
    shows.forEach(show=>{
        ...
        dateTime[date].push({time:show.showDateTime.toISOString().split('T')[1].substring(0,5), showId:show._id})
    })
